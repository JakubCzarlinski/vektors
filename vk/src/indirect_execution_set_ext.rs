...
pub struct IndirectExecutionSetEXTDispatchTable {
  ...
  #[cfg(feature = "VK_EXT_device_generated_commands")]
  pub vkUpdateIndirectExecutionSetPipelineEXT: Option<PFN_vkUpdateIndirectExecutionSetPipelineEXT>,
  #[cfg(feature = "VK_EXT_device_generated_commands")]
...
impl<'dev> Drop for IndirectExecutionSetEXT<'dev> {
  fn drop(&mut self) {
    ...
    unsafe {
      ((&self.parent.indirect_execution_set_ext_table).vkDestroyIndirectExecutionSetEXT)
...
impl<'dev> IndirectExecutionSetEXT<'dev> {
  ...
  pub const fn table(&self) -> &IndirectExecutionSetEXTDispatchTable {
    &self.parent.indirect_execution_set_ext_table
  }
