...
pub struct SwapchainKHRDispatchTable {
  ...
  #[cfg(feature = "VK_EXT_present_timing")]
  pub vkSetSwapchainPresentTimingQueueSizeEXT: Option<PFN_vkSetSwapchainPresentTimingQueueSizeEXT>,
  #[cfg(feature = "VK_GOOGLE_display_timing")]
    ...
    F: Fn(*const c_char) -> Option<unsafe extern "system" fn()>,
  {
    Self {
      ...
      vkGetSwapchainCounterEXT: loader(c"vkGetSwapchainCounterEXT".as_ptr())
        .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_full_screen_exclusive")]
      vkAcquireFullScreenExclusiveModeEXT: loader(c"vkAcquireFullScreenExclusiveModeEXT".as_ptr())
        .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_full_screen_exclusive")]
      vkReleaseFullScreenExclusiveModeEXT: loader(c"vkReleaseFullScreenExclusiveModeEXT".as_ptr())
        .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_present_timing")]
      ...
      .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_present_timing")]
      vkGetSwapchainTimingPropertiesEXT: loader(c"vkGetSwapchainTimingPropertiesEXT".as_ptr())
        .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_present_timing")]
      ...
      .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_GOOGLE_display_timing")]
      vkGetPastPresentationTimingGOOGLE: loader(c"vkGetPastPresentationTimingGOOGLE".as_ptr())
        .map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_GOOGLE_display_timing")]
