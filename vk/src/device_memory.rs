...
impl DeviceMemoryDispatchTable {
    ...
    F: Fn(*const c_char) -> Option<unsafe extern "system" fn()>,
  {
    Self {
      ...
      #[cfg(feature = "VK_BASE_VERSION_1_0")]
      vkMapMemory: loader(c"vkMapMemory".as_ptr()).map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_BASE_VERSION_1_0")]
      vkUnmapMemory: loader(c"vkUnmapMemory".as_ptr()).map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_EXT_pageable_device_local_memory")]
