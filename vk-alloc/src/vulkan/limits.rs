...
use vk::{
    PhysicalDevice, VkPhysicalDeviceExternalMemoryHostPropertiesEXT,
    VkPhysicalDeviceMaintenance3Properties, VkPhysicalDeviceMemoryProperties,
    VkPhysicalDeviceMemoryProperties2, VkPhysicalDeviceProperties2,
};
