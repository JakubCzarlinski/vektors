...
pub struct QueueDispatchTable {
  ...
  #[cfg(feature = "VK_INTEL_performance_query")]
  pub vkQueueSetPerformanceConfigurationINTEL: Option<PFN_vkQueueSetPerformanceConfigurationINTEL>,
  #[cfg(feature = "VK_KHR_swapchain")]
...
impl QueueDispatchTable {
    ...
    F: Fn(*const c_char) -> Option<unsafe extern "system" fn()>,
  {
    Self {
      ...
      #[cfg(feature = "VK_BASE_VERSION_1_0")]
      vkQueueSubmit: loader(c"vkQueueSubmit".as_ptr()).map(|f| unsafe { core::mem::transmute(f) }),
      #[cfg(feature = "VK_BASE_VERSION_1_0")]
