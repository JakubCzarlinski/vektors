...
use windows_sys::Win32::{
    Foundation::{
        CloseHandle, ERROR_INSUFFICIENT_BUFFER, ERROR_MOD_NOT_FOUND, ERROR_SUCCESS, GetLastError,
    ...
    System::{
        ...
        LibraryLoader::{
            GetModuleFileNameW, GetModuleHandleA, GetProcAddress, LOAD_LIBRARY_SEARCH_DEFAULT_DIRS,
            LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR, LoadLibraryExA, LoadLibraryExW, LoadLibraryW,
        },
        Registry::{
